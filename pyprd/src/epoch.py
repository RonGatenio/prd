...
class Epoch(EpochBase):
    def __gt__(self, other: 'EpochBase') -> bool:
        return super().__gt__(self.__class__(other))
    
    def __ge__(self, other: 'EpochBase') -> bool:
        return super().__ge__(self.__class__(other))
    
    def __lt__(self, other: 'EpochBase') -> bool:
        return super().__lt__(self.__class__(other))
    
    def __le__(self, other: 'EpochBase') -> bool:
        return super().__le__(self.__class__(other))


class ReverseEpoch(EpochBase):
    def __gt__(self, other: 'EpochBase') -> bool:
        return super().__lt__(self.__class__(other))
